...
import com.example.instaclone.ProfileFragment;
...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder> {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isFargment) {
                    ...
                    ((FragmentActivity)mContext).getSupportFragmentManager().beginTransaction().replace(R.id.m_contain, new ProfileFragment()).commit();
                } else {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            Log.i("recycler123", "1");
            imageProfile = itemView.findViewById(R.id.user_image);
            username = itemView.findViewById(R.id.user_name);
            fullname = itemView.findViewById(R.id.user_fullname);
            btnFollow = itemView.findViewById(R.id.user_follow);
